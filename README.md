...
2. **Instalação dos pacotes e softwares essenciais:**
   - Instalação de todos os softwares e dependencias necessários para o uso diário do sistema.
3. **Instalação de pacotes via "Distrobox":**
   - Utilização do "Distrobox" para instalar softwares provenientes do repositório do **Arch Linux**.
